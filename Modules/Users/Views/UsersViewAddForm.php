...
<div class="panel mb25 mt5">
    <div class="panel-heading br-b-ddd"><span class="panel-title hidden-xs"> Add New Customer</span>
        <ul class="nav panel-tabs-border panel-tabs">
            <li class="active"><a href="#tab1_1" data-toggle="tab" aria-expanded="true">General</a></li>
            <li class=""><a href="#tab1_2" data-toggle="tab" aria-expanded="false">Settings</a></li>
            <li class=""><a href="#tab1_3" data-toggle="tab" aria-expanded="false">Billing</a></li>
        </ul>
    </div>
