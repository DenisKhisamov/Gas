                        ...
                        <div class="col-md-9 pl15">
                            <div class="section row mb15">
                                <div class="col-xs-12 col-md-6">
                                    <?php echo $this->getTextInput('name', 'text', '', 'Наименование', 'Введите наименование', 'building-o'); ?>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <?php echo $this->getTextInput('address', 'text', '', 'Адрес', 'Введите адрес', 'map-marker'); ?>
                                </div>
                            </div>
                            <div class="section row mb15">
                                <div class="col-xs-12 col-md-6">
                                    <?php echo $this->getTextInput('lat', 'text', '', 'Latitude', 'Введите latitude', 'map-marker'); ?>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <?php echo $this->getTextInput('lon', 'text', '', 'Longitude', 'Введите longitude', 'map-marker'); ?>
                                </div>
                            </div>
                            <div class="section row mb15">
                                <div class="col-xs-12 col-md-6">
                                    <?php echo $this->getSelect('user_id', 0,$data['users'], 'Отвественный');?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
