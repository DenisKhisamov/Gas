...
<div class="panel mb25 mt5">
    <div class="panel-heading br-b-ddd"><span class="panel-title hidden-xs"> Редактирование объекта</span>
        <ul class="nav panel-tabs-border panel-tabs">
            <li class="<?php echo (empty($data['events_tab'])?'active':'');?>"><a href="#tab1_1" data-toggle="tab" aria-expanded="true">Основные</a></li>
            <li class=""><a href="#tab1_2" data-toggle="tab" aria-expanded="false">Дополнительно</a></li>
            <li class="<?php echo (!empty($data['events_tab'])?'active':'');?>"><a href="#tab1_4" data-toggle="tab" aria-expanded="false">События</a></li>
        </ul>
    </div>
    <div class="panel-body p20 pb10">
        <div class="tab-content pn br-n admin-form">
            <div id="tab1_1" class="tab-pane <?php echo (empty($data['events_tab'])?'active':'');?>">
                    ...
                    <div class="section row mbn">
                        <div class="col-md-9 pl15">
                            <div class="section row mb15">
                                <div class="col-xs-6">
                                    <?php echo $this->getTextInput('name', 'text', $data['object']['name'], '', 'Введите ФИО', 'building-o'); ?>
                                </div>
                                <div class="col-xs-6">
                            ...
                            <div class="section row mb15">
                                <div class="col-xs-6">
                                    <?php echo $this->getTextInput('address', 'text', $data['object']['address'], '', 'Введите домашний адрес', 'map-marker'); ?>
                                </div>
                                <div class="col-xs-6">
                            ...
                            <div class="section row mb15">
                                <div class="col-xs-6">
                                    <?php echo $this->getTextInput('lat', 'text', $data['object']['lat'], '', 'Введите latitude', 'map-marker'); ?>
                                </div>
                                <div class="col-xs-6">
                                    <?php echo $this->getTextInput('lon', 'text', $data['object']['lon'], '', 'Введите longitude', 'map-marker'); ?>
                                </div>
                            </div>
                            <div class="section row mb15">
                                <div class="col-xs-6">
                            ...
                            <div class="section row mb15">
                                <div class="col-xs-6">
                                    <?php echo $this->getSelect('user_id', $data['object']['user_id'],$data['users']);?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
            ...
            <div id="tab1_4" class="tab-pane <?php echo (!empty($data['events_tab'])?'active':'');?>">
                <?php echo $this->getView('Events',$moduleName,$data);?>
            </div>
        </div>
    </div>
</div>