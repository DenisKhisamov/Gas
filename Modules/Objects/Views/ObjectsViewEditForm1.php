...
<div class="panel mb25 mt5">
    <div class="panel-heading br-b-ddd"><span class="panel-title hidden-xs"> Редактирование объекта</span>
        <ul class="nav panel-tabs-border panel-tabs">
            <li class="<?php echo (empty($data['services_tab'])?' active':'');?>"><a href="#tab1_1" data-toggle="tab" aria-expanded="true">Основные</a></li>
            <li class=""><a href="#tab1_2" data-toggle="tab" aria-expanded="false">Технические характеристики</a></li>
            <li class="<?php echo (!empty($data['services_tab'])?' active':'');?>"><a href="#tab1_3" data-toggle="tab" aria-expanded="false">Обслуживание</a></li>
            <!--li class=""><a href="#tab1_4" data-toggle="tab" aria-expanded="false">События</a></li-->
        </ul>
    </div>
    <div class="panel-body p20 pb10">
        <div class="tab-content pn br-n admin-form">
            <div id="tab1_1" class="tab-pane<?php echo (empty($data['services_tab'])?' active':'');?>">
                        ...
                        <div class="col-md-9 pl15">
                            <div class="section row mb15">
                                <div class="col-xs-12 col-md-6">
                                    <?php echo $this->getTextInput('name', 'text', $data['object']['name'], 'Наименование', 'Введите наименование', 'building-o'); ?>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <?php echo $this->getTextInput('address', 'text', $data['object']['address'], 'Адрес', 'Введите адрес', 'map-marker'); ?>
                                </div>
                            </div>
                            <div class="section row mb15">
                                <div class="col-xs-12 col-md-6">
                                    <?php echo $this->getTextInput('lat', 'text', $data['object']['lat'], 'Latitude', 'Введите latitude', 'map-marker'); ?>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <?php echo $this->getTextInput('lon', 'text', $data['object']['lon'], 'Longitude', 'Введите longitude', 'map-marker'); ?>
                                </div>
                            </div>
                            <div class="section row mb15">
                                <div class="col-xs-12 col-md-6">
                                    <?php echo $this->getSelect('user_id', $data['object']['user_id'],$data['users'],'Отвественный');?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
            ...
            <div id="tab1_2" class="tab-pane">
                <div class="section row mbn">
                    <div class="col-xs-6 pr15">
                        <label style="margin-bottom: 5px;margin-top: 10px;margin-left: 1px; font-size: 18px;font-weight: bold;">Вид задвижки</label>
                        <div class="section">
                            <label for="customer-language" class="field select">
                                <select id="customer-language" name="customer-language" class="empty">
                                    <option value="0" selected="selected">С закрытым шпинделем</option>
                                    <option value="1">С выдвигающимся шпинделем</option>
                                </select><i class="arrow double"></i>
                            </label>
                        </div>
                        <label style="margin-bottom: 5px;margin-top: 10px;margin-left: 1px; font-size: 18px;font-weight: bold;">Корпус</label>
                        <div class="section mb10">
                            <label for="customer-group" class="field select">
                                <select id="customer-group" name="customer-group" class="empty">
                                    <option value="0" selected="selected">Сталь</option>
                                    <option value="1">Чугун</option>
                                </select><i class="arrow double"></i>
                            </label>
                        </div>
                        <div class="section mb10">
                            <label for="cust-phone" class="field prepend-icon">
                                <input id="cust-phone" type="text" name="cust-phone" placeholder="Диаметр(см)" class="event-name gui-input bg-light br-light">
                                <label for="cust-phone" class="field-icon"></label>
                            </label>
                        </div>
                        <label style="margin-bottom: 5px;margin-top: 10px;margin-left: 1px; font-size: 18px;font-weight: bold;">Вид устройства запирающего элемента</label>
                        <div class="section">
                            <label for="customer-language" class="field select">
                                <select id="customer-language" name="customer-language" class="empty">
                                    <option value="0" selected="selected">Шиберные</option>
                                    <option value="1">Шланговые</option>
                                    <option value="2">Параллельные</option>
                                    <option value="3">Клиновые</option>
                                </select><i class="arrow double"></i>
                            </label>
                        </div>
                    </div>
            ...
            <div id="tab1_3" class="tab-pane<?php echo (!empty($data['services_tab'])?' active':'');?>">
                <?php echo $this->getView('Services',$moduleName,$data);?>
            </div>
