...
<div class="panel mb25 mt5">
    <div class="panel-heading br-b-ddd"><span class="panel-title hidden-xs"> Редактирование объекта</span>
        <ul class="nav panel-tabs-border panel-tabs">
            ...
            <li class=""><a href="#tab1_3" data-toggle="tab" aria-expanded="false">Обслуживание</a></li>
                    ...
                    <div class="section row mbn">
                        <div class="col-md-9 pl15">
                            <div class="section row mb15">
                                <div class="col-xs-6">
                                    <?php echo $this->getTextInput('name', 'text', $data['object']['name'], '', 'Введите наименование', 'building-o'); ?>
                                </div>
                                <div class="col-xs-6">
                                    <?php echo $this->getTextInput('address', 'text', $data['object']['address'], '', 'Введите адрес', 'map-marker'); ?>
                                </div>
                            </div>
                            <div class="section row mb15">
                                <div class="col-xs-6">
                            ...
                            <div class="section row mb15">
                                <div class="col-xs-6">
                                    <?php echo $this->getSelect('type_id', $data['object']['type_id'],$data['objects_types'],'disabled');?>
                                </div>
                                <div class="col-xs-6">
