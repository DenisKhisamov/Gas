                    ...
                    <div class="section row mbn">
                        <div class="col-md-9 pl15">
                            <div class="section row mb15">
                                <div class="col-xs-6">
                                    <?php echo $this->getTextInput('name', 'text', '', '', 'Введите наименование', 'building-o'); ?>
                                </div>
                                <div class="col-xs-6">
                                    <?php echo $this->getTextInput('address', 'text', '', '', 'Введите адрес', 'map-marker'); ?>
                                </div>
                            </div>
                            <div class="section row mb15">
                                <div class="col-xs-6">
                            ...
                            <div class="section row mb15">
                                <div class="col-xs-6">
                                    <?php echo $this->getSelect('type_id', 0,$data['objects_types']);?>
                                </div>
                                <div class="col-xs-6">
